...
public class AddEmployee extends JFrame implements ActionListener {
    ...
    JTextField tfname, tfaddress, tfphone, tfemail, tfsalary, tfjob, tfhours, tfbasesalary;
    JDateChooser dcdob;
    ...
    AddEmployee() {
        ...
        cbEmployeeType.setSelectedItem("Full Time");
        add(cbEmployeeType);
        ...
        tfhours = new JFormattedTextField(formatter);
